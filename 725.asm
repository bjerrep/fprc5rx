...
#define 					REMOTE_DECODER_TRAPS_ON
		...
		ifdef __16F873
			include "..\\Extern\\P16F873.INC"
		endif
		ifdef __16F877
			include "..\\Extern\\P16F877.INC"
		endif


         ; Custom include files
         ;
			include	"..\\common\\PicDelay.inc"
NOF_PROGRAM_PAGES	equ	2
			include	"..\\common\\common.inc"
			include "..\\common\\16f873.inc"
			...
			include	"..\\rc5rx\\RC5.asm"

			; i2c
			; ----------------------
			;
			include "..\\common\\i2c_defs.inc"
